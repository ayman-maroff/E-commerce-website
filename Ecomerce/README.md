...
purely native PHP ! The Ecomerce skeleton tries to be the extremely slimmed down opposite of big frameworks
...
Have a look here: https://github.com/panique/Ecomerce-advanced
...
There's a tutorial on [How to install Ecomerce on Windows 7, 8 and 8.1](http://www.dev-metal.com/install-Ecomerce-windows-7/).
...
```
git clone https://github.com/panique/Ecomerce.git /var/www
```

or c) getting the repo via Composer (here we copy into var/www)

```
composer create-project panique/Ecomerce /var/www dev-master
```
...
```php
define('URL', 'http://127.0.0.1/Ecomerce/');
```
...
![Ecomerce introduction tutorial - page 1](_tutorial/tutorial-part-01.png)
![Ecomerce introduction tutorial - page 2](_tutorial/tutorial-part-02.png)
![Ecomerce introduction tutorial - page 3](_tutorial/tutorial-part-03.png)
![Ecomerce introduction tutorial - page 4](_tutorial/tutorial-part-04.png)
![Ecomerce introduction tutorial - page 5](_tutorial/tutorial-part-05.png)
...
[![Bitdeli Badge](https://d2weczhvl823v0.cloudfront.net/panique/Ecomerce/trend.png)](https://bitdeli.com/free "Bitdeli Badge")
