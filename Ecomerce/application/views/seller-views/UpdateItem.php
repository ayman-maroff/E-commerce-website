...
<div class="form-container">
  <div class="input-container">
    ...
    <form method="POST" action="<?php echo URL . 'Items/updateItem/' . $item[0]->id.'/'.$item[0]->count.'/'.$item[0]->User_id; ?>" enctype="multipart/form-data">
      <div class="form-group">
        <label class="tit" for="description">Description:</label>
        <input id="description" type ="text" name="description" rows="4" required value ="<?php echo $item[0]->description ?>"></input>
      </div>
      <div class="form-group">
        <label class="tit" for="quantity">Quantity:</label>
        <input type="number" id="quantity" name="quantity" required value ="<?php echo $item[0]->count ?>">
      </div>
      <div class="form-group">
        <label class="tit" for="price">Price:</label>
        <input type="number" id="price" name="price" required value ="<?php echo $item[0]->price ?>">
      </div>
