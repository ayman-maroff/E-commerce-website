...
<div class="sidebar">
  ...
  <ul class="nav-list">
    ...
    <?php $temp1 =   $_SESSION['userid']; ?>
      <a href="<?php echo URL .'Items/itemsListSeller/'.$temp1; ?>">
        <i class='bx bx-grid-alt'></i>
        <span class="links_name">My Items</span>
      </a>
    ...
    <li>
      <?php $temp1 =   $_SESSION['userid']; ?>
      <a href="<?php echo URL . 'stores/StoresListSeller' . "/" . $temp1; ?>">
    ...
    <li>
      <?php $temp1 =   $_SESSION['userid']; ?>
      <a href="<?php echo URL . 'orders/SellerReceivablesList/'.$temp1;?>">
        <i class='bx bx-dollar'></i>

        <span class="links_name">My Receivables</span>
      </a>
      <!-- <span class="tooltip">Users</span> -->
    </li>
    <li>
