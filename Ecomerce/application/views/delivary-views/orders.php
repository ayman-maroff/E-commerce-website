...
<br />
<br />
<h1 class="note1" style="margin-left:500px"> Ther are no orders to show! </h1><br>
<?php
} else {
?>
    ...
    for ($i = 0; $i < count($orders); $i++) 
   {
    ?>
      <tr>
        ...
        <td><?php echo  $orders[$i]->buyer_number?> </td>
        <td><?php echo  $orders[$i]->buyer_address?> </td>
        <!-- <td><i class='bx bx-cart-alt'></i></td> -->
        <td><a  href="<?php echo URL . 'carts/cartListD/'.$orders[$i]->Cart_id;?>" class="btn_del"><span>Cart</span></a></td>
        <td><a  href="<?php echo URL . 'orders/AcceptOrder/'.$orders[$i]->id.'/'.$orders[$i]->Cart_id;?>" class="btn_del"><span>Accept</span></a></td>
      </tr>
    <?php
    }
    ?>
