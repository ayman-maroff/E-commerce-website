...
<table class="content-table">
  ...
  <tbody>
    <?php foreach ($users as $user) { ?>
      <tr>
      <td><?php if (isset($user->iid)) echo $user->iid; ?></td>
        <td><?php if (isset($user->firstname)) echo $user->firstname; ?></td>
        <td><?php if (isset($user->midlname)) echo $user->midlname; ?></td>
        ...
        <td><a href="<?php echo URL . 'user/prepareTodeleteUser/' . $user->iid; ?>" class="btn_del"><i id="deltbtn"  class="fa fa-trash"></i></a></td>
     <?php }else{?>
        <td></td>
      <?php }?>
      </tr>
